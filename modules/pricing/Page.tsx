...
export default function PricingPage({ items, settings, title, route, options }: ModulePageProps) {
  ...
  return (
    ...
    >
      <PricingSection items={list} title="" ctaHref={options?.hasContact ? "/#contacto" : undefined} />
    </ModuleIndexPage>
  )
}
